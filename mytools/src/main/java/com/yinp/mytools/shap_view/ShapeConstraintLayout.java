package com.yinp.mytools.shap_view;
...
import com.yinp.mytools.R;
import com.yinp.mytools.utils.ToolsUtils;
...
public class ShapeConstraintLayout extends ConstraintLayout {
    ...
    private void initShape(int leftTopRadius, int rightTopRadius, int leftBottomRadius, int rightBottomRadius) {
        if (leftBottomRadius != 0 || leftTopRadius != 0 || rightTopRadius != 0 || rightBottomRadius != 0) {
            leftBottomRadius =  ToolsUtils.dpToPx(context, leftBottomRadius);
            leftTopRadius =  ToolsUtils.dpToPx(context, leftTopRadius);
            rightTopRadius =  ToolsUtils.dpToPx(context, rightTopRadius);
            rightBottomRadius =  ToolsUtils.dpToPx(context, rightBottomRadius);
